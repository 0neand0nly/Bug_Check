...
import testcases.CWE549_Missing_Password_Masking.CWE549_Missing_Password_Masking__Servlet_01;
...
public class ServletMain extends HttpServlet {
	...
	private static void doGetCWE5(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			(new CWE549_Missing_Password_Masking__Servlet_01()).runTest(request, response);
			;
